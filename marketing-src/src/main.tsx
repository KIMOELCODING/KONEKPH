...
if (configMissing) {
  console.error('[marketing boot] config.js missing or has placeholder values.');
      ...
      <div class="login-shell">
        <div class="login-card">
          ...
          <div class="alert alert-error" style="margin-top:12px"><i class="fa-solid fa-circle-exclamation"></i>
            Marketing app configuration is missing. <code>config.js</code> did not load, or contains placeholder values. Please contact your administrator.
          </div>
        </div>
      </div>`;
  }
